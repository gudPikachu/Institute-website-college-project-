...
<title>::. Maharaja Ranjit Singh College Management Tool.::</title>
...
<div id="admin">
    ...
    <div id="rmain">
    	<!-- <div id="pic_manu">
    		<a href="#" title="Studnt"><img src="picture/mrsc-top-logo.gif" hspace="10px" /></a>
         </div>  -->
         ...
         <div id="menu2">
                ...
                <li id="li_menu"><a href="">Faculty</a>
                
                    
                    <ul>
                        <li id="li_submenu"><a href="everyone.php?tag=faculties_entry" class=" order">Faculty Entry</a></li>
                        <li id="li_submenu"><a href="everyone.php?tag=view_faculties" class="customer">View Faculty</a></li>
                    </ul>
                ...
                <li id="li_menu"><a href="#">Subjects</a>
                    ...
                    <ul>
                    	<li id="li_submenu"><a href="everyone.php?tag=subject_entry" class=" customer">Subject Entry</a></li>
